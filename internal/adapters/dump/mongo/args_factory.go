...
// ArgsFactory builds *DumpMongoArgs from a pure ports.DumpJobSpec (spec 040 /
// PRD 27). Body lifted from the former config.BuildMongoDumpArgs (gzip ->
// Compress, no password); Storage is set by the command layer.
