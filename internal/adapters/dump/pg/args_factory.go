...
// from the former config.BuildPgDumpArgs; the Storage, TLS, and PITR/WAL fields
// are intentionally left zero — the command layer sets Storage, and PITR
// metadata is populated later in the pipeline.
